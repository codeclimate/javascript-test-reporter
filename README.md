...
Supplies a script which accepts [lcov](https://github.com/linux-test-project/lcov) data over standard input, formats the coverage data and sends it to [Code Climate](https://codeclimate.com).
